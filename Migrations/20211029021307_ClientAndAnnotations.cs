    ...
    public partial class ClientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2021, 10, 28, 22, 13, 7, 11, DateTimeKind.Local).AddTicks(9219), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2021, 10, 28, 22, 13, 7, 19, DateTimeKind.Local).AddTicks(5409), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2021, 10, 28, 22, 13, 7, 19, DateTimeKind.Local).AddTicks(5296), 7 });
