...
namespace RazorPages.Migrations
{
    ...
    [Migration("20211029021307_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 28, 22, 13, 7, 11, DateTimeKind.Local).AddTicks(9219),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2021, 10, 28, 22, 13, 7, 19, DateTimeKind.Local).AddTicks(5296),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 28, 22, 13, 7, 19, DateTimeKind.Local).AddTicks(5409),
                            ServicesID = 5
                        });
                });
